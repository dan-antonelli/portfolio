import Assets, { StoryAssets } from './assets';
import { getStoryCategories } from './skills';
import type { Story } from '../types';

export const items: Array<Story> = [
	{
		slug: 'clerical-error',
		color: 'green',
		...
		logo: Assets.Writing,
		name: `Clerical Error`,
		coverImage: StoryAssets.ClericalError,
		period: {
			from: new Date(2024, 4, 22)
		},
		categories: getStoryCategories('fantasy'),
		type: '',
		description: `
...
export const title = 'Short Stories';
