import{A as e}from"./index.4ebf5a1f.js";import{g as t}from"./skills.9265f22a.js";const i=[{slug:"github-pages-to-squarespace",color:"#5e95e3",description:`
...
`,shortDescription:"Having your own domain is like buying a house instead of renting an apartment. You paint the walls (metaphorically, at least)...",links:[],logo:e.GitHub,name:"From Renter to Owner: Setting Up a Custom Domain with GitHub Pages and Squarespace",period:{from:new Date(2024,2,23),to:new Date(2024,2,23)},skills:t("github"),type:""}],a="Blog posts";export{i,a as t};
