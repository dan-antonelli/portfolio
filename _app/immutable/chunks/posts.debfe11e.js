import{A as e}from"./index.4611e0d8.js";import{g as t}from"./skills.e3c7a16f.js";const a=[{slug:"github-pages-to-squarespace",color:"#5e95e3",description:`
...
`,shortDescription:"Having your own domain is like buying a house instead of renting an apartment. You paint the walls (metaphorically, at least), decide on the landscaping, and have full control...",links:[],logo:e.Writing,name:"From Renter to Owner: Setting Up a Custom Domain with GitHub Pages and Squarespace",period:{from:new Date(2024,2,23),to:new Date(2024,2,23)},skills:t(""),type:""}],i="Blog posts";export{a as i,i as t};
