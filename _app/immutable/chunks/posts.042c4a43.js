import{A as e}from"./index.90804482.js";import{g as t}from"./skills.53d3e207.js";const r=[{slug:"github-pages-to-squarespace",color:"#5e95e3",description:`
...
`},{slug:"the-ocd-developer",color:"green",shortDescription:"In the good old days, being on the spectrum was an asset for programming; today, having OCD might be the winning ticket.",links:[],logo:e.Writing,name:"OCD might be your winning ticket",period:{from:new Date(2024,4,20)},skills:t(),type:"",description:`
...
`}],s="Blog posts";export{r as i,s as t};
