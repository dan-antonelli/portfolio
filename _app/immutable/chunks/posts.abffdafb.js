import{B as e,A as t}from"./index.92bfbdec.js";import{a as o}from"./skills.5a349d98.js";const a=[{slug:"github-pages-to-squarespace",color:"#5e95e3",description:`
...
<div style="display: flex; flex-direction: column; align-items: center;">
    <img src="${e.DNS}" alt="dns webcomic" style="max-width: 100%; height: auto;"/>
...
<div style="display: flex; flex-direction: column; align-items: center;">
    <img src="${e.Manul}" alt="manul" style="max-width: 100%; height: auto;"/>
...
<div style="display: flex; flex-direction: column; align-items: center;">
    <img src="${e.Senior}" alt="senior dev dilbert comic" style="max-width: 100%; height: auto;"/>
</div>
<br><br>
...
<div style="display: flex; flex-direction: column; align-items: center;">
    <img src="${e.Ocd}" alt="ocd comics" style="max-width: 100%; height: auto;"/>
</div>
